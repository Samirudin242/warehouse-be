...
public class CartDataAccessMapper {
    ...
    public CartDataAccessMapper(ProductColorsJpaRepository productColorsRepository, ProductSizeJpaRepository productSizeJpaRepository) {
        ...
        return cartEntity.getCartItemEntities().stream()
                .map(cartItemEntity -> {
                    ...
                    return new Cart(
                            ...
                            (double) cartItemEntity.getPrice()
                    );
                })
                .toList();
    }
